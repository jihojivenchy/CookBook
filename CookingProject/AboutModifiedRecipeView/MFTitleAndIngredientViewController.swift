//
//  MFTitleAndIngredientViewController.swift
//  CookingProject
//
...
final class MFTitleAndIngredientViewController: UIViewController {
//MARK: - Properties
    ...
    private lazy var titleTextField : UITextField = {
        ...
        tf.delegate = self
        tf.text = modifyRecipeData?.foodName
        return tf
    }()
    ...
    private lazy var ingredientsTextView : UITextView = {
        ...
        tv.delegate = self
        tv.text = modifyRecipeData?.ingredients
    ...
    private func setStackView() {
        ...
        let stackViewArray = [modifyRecipeData.foodCategory, modifyRecipeData.foodLevel, "", ""]
    ...
    @objc private func nextButtonPressed(_ sender : UIButton){
        ...
        if titleText == "" {
            ...
            if ingreText == "" {
                ...
                modifyRecipeData?.foodName = titleText
                modifyRecipeData?.ingredients = ingreText
                
                let vc = MFRecipeProcessViewController()
...
//MARK: - Extension
extension MFTitleAndIngredientViewController : UITextFieldDelegate {
...
extension MFTitleAndIngredientViewController : UITextViewDelegate {
